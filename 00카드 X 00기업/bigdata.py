...
spark = SparkSession.builder.appName('missing').config("spark.executor.memory", "8g").getOrCreate()
...
start = time.time()
# A_B를 기준으로 A와 조인
result_A = a_2000.join(aa_seq_id, a_2000.colNo  == aa_seq_id.seq_id, how="inner")
